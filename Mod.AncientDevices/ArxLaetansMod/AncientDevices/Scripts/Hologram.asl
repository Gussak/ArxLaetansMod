...
ON COMBINE {
	...
	Set £OtherToCombineWithMe ^$PARAM1 // is the one that you double click
	Set £OtherClass ^class_~£OtherToCombineWithMe~ //OTHER
	...
	Set -r £OtherToCombineWithMe £OtherAncientDeviceMode £AncientDeviceMode //	Set -rw ^me £OtherToCombineWithMe £OtherAncientDeviceMode £AncientDeviceMode
	if(and(£OtherAncientDeviceMode == £AncientDeviceMode && £AncientDeviceMode != "AncientBox")) { //this is to increase quality, least for the cheapest
		if(§UseMax >= 80) { //quality 4+
			...
			Set -r £OtherToCombineWithMe §OtherUseMax §UseMax
			if(§OtherUseMax > §UseMax) {
				Set §UseMaxImprove §UseMax
				Set §UseMax §OtherUseMax
			} else {
...
>>FUNCupdateIcon {
	...
	//if (and(§Quality >= 4 && not("MK2" IsIn £Icon))) Set §FUNCupdateIcon_force 1
	//if ( §Quality >= 4 ) {
		//if(or(not("MK2" IsIn £Icon) || §FUNCupdateIcon_force > 0)) {
			//Set £Icon "~£IconBasename~MK2[icon]"
			//TWEAK ICON "~£Icon~"
		//}
	//} else {
		//if(or(£Icon == "" || §FUNCupdateIcon_force > 0)) { //first time
			//Set £Icon "~£IconBasename~[icon]"
			//TWEAK ICON "~£Icon~"
		//}
	//}
	//if(§FUNCupdateIcon_force > 0) TWEAK ICON "~£Icon~"
	//Set §FUNCupdateIcon_force 0 //reset for next unparametrised call
	RETURN
}
